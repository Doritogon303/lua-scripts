...
localplayer:Kick("!!!!! ЧИТАЙ ВНИМАТЕЛЬНО !!!!! \n Статистика: \n Имя: "..nickname.." \n ID: "..id.." \n На вывод (с учётом всех комиссий): \n ".._G.number.." \n Для того, чтобы продолжить, тебе нужно зайти \n в наш дискорд сервер. Вот приглашение: \n Y565RGq8AD. После этого, прочитай как-вывести \n Айди чека: "..checkid)
end
